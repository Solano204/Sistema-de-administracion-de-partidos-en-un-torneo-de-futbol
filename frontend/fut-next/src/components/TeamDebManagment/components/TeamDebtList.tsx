// File: src/app/features/teamDebt/components/TeamDebtList.tsx
import { memo, useMemo, useCallback } from 'react';
import clsx from 'clsx';
import { TeamDebtRecordDto, DebtStatus } from '../types/team-debt-types';

type TeamDebtListProps = {
  debts: TeamDebtRecordDto[];
  onEdit: (debt: TeamDebtRecordDto) => void;
    ...
    <tr>
      <td colSpan={6} className="px-6 py-12 text-center text-gray-500 dark:text-gray-400">
        <div className="flex flex-col items-center">
          ...
          <p className="text-lg font-medium">No team debts found</p>
          <p className="mt-1 text-sm"> Agregar un nuevo team debt</p>
        </div>
      </td>
    </tr>
  );
...
export const TeamDebtList = memo(function TeamDebtList({
  debts,
  onEdit,
  onDelete,
  onUpdateStatus,
...
type TeamDebtRowProps = {
  debt: TeamDebtRecordDto;
  onEdit: (debt: TeamDebtRecordDto) => void;
  onDelete: (id: string) => void;
  onUpdateStatus: (id: string, status: DebtStatus) => void;
  isDeleting: boolean;
...
const TeamDebtRow = memo(function TeamDebtRow({
  debt,
  onEdit,
  onDelete,
  onUpdateStatus,
