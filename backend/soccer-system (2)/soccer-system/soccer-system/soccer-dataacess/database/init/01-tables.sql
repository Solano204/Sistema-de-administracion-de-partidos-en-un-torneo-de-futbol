...
-- Updated table creation that matches your JPA entity
CREATE TABLE fut_jaguar.weekly_schedule (
    ...
    tournament_name VARCHAR(100) NOT NULL,
    category_name VARCHAR(100) NOT NULL,  -- Only category_name, no category_id
...
ALTER TABLE fut_jaguar.weekly_schedule
ADD COLUMN category_id UUID REFERENCES fut_jaguar.categories(id) ON DELETE CASCADE;

-- Then update existing records if needed
UPDATE fut_jaguar.weekly_schedule ws
