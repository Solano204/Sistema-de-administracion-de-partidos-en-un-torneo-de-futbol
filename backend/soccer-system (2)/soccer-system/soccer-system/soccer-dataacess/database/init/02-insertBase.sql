...
VALUES 
-- Administrators
('Admin', 'One', 'admin1', md5('password123'), 30, CURRENT_DATE - INTERVAL '30 years', 'ADMINISTRADOR'),
('Admin', 'Two', 'admin2', md5('password123'), 35, CURRENT_DATE - INTERVAL '35 years', 'ADMINISTRADOR'),
('Admin', 'Three', 'admin3', md5('password123'), 40, CURRENT_DATE - INTERVAL '40 years', 'ADMINISTRADOR'),
('Admin', 'Four', 'admin4', md5('password123'), 45, CURRENT_DATE - INTERVAL '45 years', 'ADMINISTRADOR'),
